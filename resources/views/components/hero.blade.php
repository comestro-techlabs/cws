    ...
    <div class="relative flex py-12 flex-col md:flex-row bg-slate-100 h-auto md:h-[500px] my-0 py-7 md:py-2 items-center px-5 md:px-[10%] overflow-hidden ">
        ...
        <div class="relative flex-1 flex-col max-w-lg ml-5 gap-1 z-50">
            ...
            <div class="flex items-center gap-3">
                <button onclick="toggleModal()" class="block text-white text-lg bg-orange-600 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-6 py-2.5 text-center dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800 items-center gap-1 flex" type="button">
