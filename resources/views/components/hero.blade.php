                        ...
                        <div class="p-4 md:p-5">
                            <form class="space-y-4" action="{{ route('public.hireUs') }}" method="post">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Ex: denish riche" required />
                                ...
                                <div>
                                    ...
                                    <input type="number" name="contact" id="contact" placeholder="Ex: 9988776655" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
