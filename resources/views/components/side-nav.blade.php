<div class="overflow-y-auto overflow-x-hidden flex-grow">
    <ul class="flex flex-col py-4 space-y-1">
        ...
        <li>
            <a href="#"
                ...
                <span class="ml-2 text-md tracking-wide truncate">Dashboard</span>
            </a>
        </li>
        <li>
        ...
        <li>
            <button type="button"
                ...
                aria-controls="dropdown-assignments" data-collapse-toggle="dropdown-assignments"
                onclick="toggleDropdown('dropdown-assignments')">
                <span class="inline-flex justify-center items-center ml-4">
    ...
    <li>
        <button type="button"
            ...
            onclick="toggleDropdown('dropdown-courses')">
            <span class="inline-flex justify-center items-center ml-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
    ...
    <li>
        <button type="button"
            ...
            onclick="toggleDropdown('dropdown-exams')">
            <span class="inline-flex justify-center items-center ml-4">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <li>
        <button type="button"
            class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 w-full"
            aria-controls="dropdown-quizs" data-collapse-toggle="dropdown-quizs"
            onclick="toggleDropdown('dropdown-quizs')">
            <span class="inline-flex justify-center items-center ml-4">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <li>
        <button type="button"
            class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 w-full"
            aria-controls="dropdown-workshops" data-collapse-toggle="dropdown-workshops"
            onclick="toggleDropdown('dropdown-workshops')">
            <span class="inline-flex justify-center items-center ml-4">
    ...
    <li>
        <button type="button"
            ...
            onclick="toggleDropdown('dropdown-students')">
            <span class="inline-flex justify-center items-center ml-4">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <ul id="dropdown-students" class="hidden py-2 space-y-2">
            <li>
                <a wire:navigate href="{{route('admin.placedstudent.edit')}}"
                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Insert
                    Student</a>
            </li>
            <li>
    ...
    <li>
        <button type="button"
            class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 w-full"
            aria-controls="dropdown-messages" data-collapse-toggle="dropdown-messages"
            onclick="toggleDropdown('dropdown-messages')">
            <span class="inline-flex justify-center items-center ml-4">
