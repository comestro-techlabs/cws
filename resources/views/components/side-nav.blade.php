<div x-data="{ expanded: true }" class="h-screen bg-white border-r border-gray-200">
    ...
    <div class="overflow-y-auto overflow-x-hidden flex-1">
        <nav class="p-3 space-y-2">
            ...
            <div class="pt-2">
                <div x-show="expanded" class="px-3 mb-2">
                    <h3 class="text-xs font-semibold text-gray-400 uppercase">Notifications</h3>
                </div>
                ...
                <div class="space-y-1">
                    <a wire:navigate href="{{route('admin.manage.enquiry')}}"
                        ...
                        <div class="flex items-center justify-between flex-1 ml-3">
                            ...
                            <span class="px-2 py-0.5 text-xs bg-purple-100 text-purple-700 rounded-full">{{ $notificationCount }}</span>
                        </div>
                    </a>
                </div>
            </div>
