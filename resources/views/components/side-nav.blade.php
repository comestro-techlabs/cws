        ...
        <div class="overflow-y-auto overflow-x-hidden flex-1">
            <nav class="p-3 space-y-2">
                ...
                <div class="pt-2">
                    ...
                    <div class="space-y-1">
                        <a wire:navigate href="{{ route('admin.course.manage') }}" class="flex items-center px-3 py-2.5 rounded-lg text-gray-600 transition-all hover:bg-purple-50 hover:text-purple-700">
                        ...
                        <a wire:navigate href="{{ route('admin.category') }}" class="flex items-center px-3 py-2.5 rounded-lg text-gray-600 transition-all hover:bg-purple-50 hover:text-purple-700">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-1">
                        <a wire:navigate href="{{ route('admin.assignment.manage') }}"
                            ...
                            <div class="flex items-center justify-between flex-1 ml-3">
                                ...
                                <span
                                    class="px-2 py-0.5 text-xs bg-purple-100 text-purple-700 rounded-full">{{ $assignmentCount }}</span>
                            </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="space-y-1">
                        <a wire:navigate href="{{ route('admin.student') }}"
                            ...
                            <div class="flex items-center justify-between flex-1 ml-3">
                                ...
                                <span
                                    class="px-2 py-0.5 text-xs bg-purple-100 text-purple-700 rounded-full">{{ $studentCount }}</span>
                            </div>
                        </a>
                        ...
                        <a wire:navigate href="{{ route('admin.batch') }}"
                            class="flex items-center px-3 py-2.5 rounded-lg text-gray-600 transition-all hover:bg-purple-50 hover:text-purple-700">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                            </svg>
                            <span class="ml-3 text-sm">Batch</span>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="space-y-1">
                        <a wire:navigate href="{{ route('admin.exam') }}"
                            ...
                            <div class="flex items-center justify-between flex-1 ml-3">
                                ...
                                <span
                                    class="px-2 py-0.5 text-xs bg-purple-100 text-purple-700 rounded-full">{{ $examCount }}</span>
                            </div>
                        </a>
                    ...
                    <div class="space-y-1">
                        <a wire:navigate href="{{ route('admin.blog.post-course') }}"
                            ...
                            <div class="flex items-center justify-between flex-1 ml-3">
                                ...
                                <span
                                    class="px-2 py-0.5 text-xs bg-purple-100 text-purple-700 rounded-full">{{ $postCourseCount }}</span>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="pt-2">
                    ...
                    <div class="space-y-1">
                        <a wire:navigate href="{{ route('v2.admin.manageProducts') }}"
                            class="flex items-center px-3 py-2.5 rounded-lg text-gray-600 transition-all hover:bg-purple-50 hover:text-purple-700">
                        ...
                        <a wire:navigate href="{{ route('admin.insert_subscription') }}"
                            class="flex items-center px-4 py-3 rounded-lg text-gray-600 transition-all hover:bg-purple-100 hover:text-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="feather feather-package w-6 h-6 text-gray-600">
                                <path d="M12 2L2 7h3v7h6V7h3l-10-5z"></path>
                                <path d="M2 17h20v2H2z"></path>
                            </svg>
                            <div class="ml-3 flex flex-col">
                                <span class="text-sm font-semibold">Subscription Plan</span>
                                <span class="text-xs text-gray-500">Manage your subscription plans</span>
                            </div>
                        </a>
                    </div>
                </div>
