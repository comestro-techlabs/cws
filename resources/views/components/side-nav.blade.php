<div class="overflow-y-auto overflow-x-hidden flex-grow bg-gray-50 h-screen">
    ...
    <ul class="flex flex-col py-4 space-y-1">
        ...
        <li class="px-5">
            <div class="flex flex-row items-center h-8">
                <div class="text-sm font-semibold tracking-wide text-purple-700">Store</div>
            </div>
        </li>
        <li>
            <a wire:navigate href="{{ route('admin.blog.post-course') }}"
                ...
                <div class="flex justify-between items-center w-full">
                <span class="ml-2 text-sm font-medium tracking-wide truncate">Manage Products</span>
                </div>
            </a>
        </li>
        <li>
            <a wire:navigate href="{{ route('admin.blog.post-course') }}"
                ...
                <div class="flex justify-between items-center w-full">
                <span class="ml-2 text-sm font-medium tracking-wide truncate">Manage Orders</span>
                </div>
            </a>
        </li>
    </ul>
