...
<body class="bg-zinc-50 flex min-h-screen font-sans antialiased sm:mt-8" x-data="{ sidebarOpen: true }">
        ...
        <main :class="{'sm:ml-64': sidebarOpen, 'ml-0': !sidebarOpen}" class="flex-1  p-4 transition-all duration-300">
