...
@section('content')
 ...
 overflow-x-hidden">
        ...
        <div class="flex flex-col">
            <section class="py-10 px-4 md:px-16">
                <div class="w-full max-w-6xl mx-auto">
                    <div class="w-full md:w-1/2">
                        <h2 class="text-lg font-semibold mb-4 text-gray-700">Ecommerce Website Development</h2>
                        <h2 class="text-2xl md:text-3xl font-bold mb-4 text-blue-900">We’re Empowering Your Digital Presence with Innovative Web Solutions</h2>
                    </div>
                ...
                <div class="w-full max-w-6xl mx-auto">
                    <ol class="space-y-4 text-gray-700 list-decimal list-inside">
                        ...
                        <li>
                            ...
                            <ul class="ps-5 mt-2 space-y-1 list-disc list-inside">
                                <li>E-commerce websites that are fully responsive, ensuring a seamless shopping experience across all devices.</li>
                        ...
                        <li>
                            ...
                            <ul class="ps-5 mt-2 space-y-1 list-disc list-inside">
                                ...
                                <li>Support for various payment methods including digital wallets, bank transfers, and Buy Now, Pay Later (BNPL) options.</li>
                        ...
                        <li>
                            ...
                            <ul class="ps-5 mt-2 space-y-1 list-disc list-inside">
                                ...
                                <li>Support for bulk product uploads, detailed product descriptions, and multiple variants (e.g., sizes, colors).</li>
                        ...
                        <li>
                            ...
                            <ul class="ps-5 mt-2 space-y-1 list-disc list-inside">
                                <li>Ongoing support services including regular updates, security patches, and performance checks.</li>
        ...
        <div class="max-w-6xl mx-auto bg-white p-10 border rounded-lg shadow-lg mt-20 mb-20">
            ...
            <div class="faq-item border border-gray-300 py-2 px-2 mb-4">
                <div class="faq-question text-lg p-2 font-medium text-blue-600 cursor-pointer">
