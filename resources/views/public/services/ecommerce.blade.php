...
@section('content')
<livewire:page-heading title="Ecommerce Website Devlopment" description="Streamline your inventory management with our tailored solutions." image="about-header.png"/>
