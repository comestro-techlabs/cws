...
@section('content')
    ...
    <section class="container mx-auto  py-24">
        <div class="max-w-3xl px-5 mx-auto text-justify">
            ...
            <p class="text-gray-700 leading-relaxed mb-6">
                <strong>Collection-</strong> We collect your personal data when you use our Platform, services or otherwise interact with us
                ...
                an appropriate law enforcement agency.</p>
