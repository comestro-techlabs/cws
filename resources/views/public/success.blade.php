...
<div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <a href="{{ route('home') }}" class="w-full py-2 px-4 bg-teal-600 text-white font-bold rounded-md text-center hover:bg-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-opacity-50">
            Go to Homepage
        </a>
    </div>
</div>
