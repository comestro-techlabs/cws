<nav class="bg-white  fixed w-full z-[999] top-0 left-0 border-b border-gray-200  roboto-bold">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-5">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-normal border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                <li>
                ...
                <li>
                    <a href="{{ route('public.about') }}" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">About Us</a>
                </li>
                <li>
                    <a href="{{ route('public.training') }}" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">Training</a>
                </li>
                <li>
                  ...
                  <div id="mega-menu-dropdown" class="absolute z-10 grid hidden w-auto grid-cols-2 text-sm bg-white border border-gray-100 rounded-lg shadow-md ">
                      <div class="p-4 pb-0 text-gray-900 md:pb-4 ">
                          <ul class="space-y-4" aria-labelledby="mega-menu-dropdown-button">
                              <li>
                                  <a href="{{ route('public.services.web-design') }}" class="text-gray-500  hover:text-blue-600">Web Design</a>
                              </li>
                              <li>
                                  <a href="{{route('public.services.web-dev')}}" class="text-gray-500  hover:text-blue-600">Web Development</a>
                              </li>
                              <li>
                                  <a href="{{route('public.services.mobile-app')}}" class="text-gray-500  hover:text-blue-600">Mobile App Development</a>
                              </li>
                              <li>
                                  <a href="{{ route('public.services.seo-services') }}" class="text-gray-500  hover:text-blue-600">SEO Services</a>
                              </li>
                              <li>
                                  <a href="{{ route('public.services.software-dev') }}" class="text-gray-500  hover:text-blue-600">Software Development</a>
                              </li>
                          </ul>
                      </div>
                      <div class="p-4 pb-0 text-gray-900 md:pb-4 ">
                          <ul class="space-y-4">
                              <li>
                                  <a href="{{ route('public.services.native-app') }}" class="text-gray-500  hover:text-blue-600 ">Native App Development</a>
                              </li>
                              <li>
                                  <a href="{{route('public.services.ecommerce')}}" class="text-gray-500  hover:text-blue-600 ">E-Commerce Website Development</a>
                              </li>
                              <li>
                                  <a href="{{route('public.services.coaching')}}" class="text-gray-500  hover:text-blue-600 ">Coaching Manangement System</a>
                              </li>
                              <li>
                                  <a href="{{ route('public.services.invent-sol') }}" class="text-gray-500  hover:text-blue-600 ">Inventory Solutions</a>
                              </li>
                          </ul>
                      </div>
                      <div class="p-4 w-48 pb-0 text-gray-900 md:pb-4 ">
                        <h2 class="mb-2 font-semibold text-gray-900 ">Our Services</h2>
                        <p class="mb-2 text-gray-500 ">At Comestro, we have a portfolio of brands that cater to a variety of preferences.</p>
                        <a href="{{route('public.services.services')}}" class="inline-flex items-center text-sm font-medium text-blue-600 hover:underline hover:text-blue-600 ">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            @auth
                @if (Auth::user()->isAdmin)
                    <a href="{{ route('admin.dashboard') }}" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center ">Admin Panel</a>
                @else
                    ...
                    <div id="dropdownAvatarName" class="hidden z-10 w-44 bg-white rounded-lg shadow ">
                        <ul class="py-2 text-sm text-gray-700 " aria-labelledby="dropdownAvatarNameButton">
                            <li><a href="{{ route('student.dashboard') }}" class="block px-4 py-2 hover:bg-gray-100 ">My Learning</a></li>
                            <li><a href="{{ route('auth.logout') }}" class="block w-full text-left px-4 py-2 hover:bg-gray-100 ">Logout</a></li>
                        </ul>
                    </div>
                @endif
            @endauth 
