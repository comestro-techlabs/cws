            ...
            <div class="mb-4 border-b mt-5">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
                    ...
                    <li class="me-2" role="presentation">
                        <button
                            class="inline-block text-slate-100 p-4 border-b-2 hover:text-gray-100 hover:border-gray-100  border-white rounded-t-lg"
                            id="profile-tab" data-tabs-target="#profile" type="button" role="tab"
                            aria-controls="profile" aria-selected="false">My Course</button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button
                            class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-100 hover:border-gray-100 "
                            id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab"
                            aria-controls="dashboard" aria-selected="false">My Payment</button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button
                            class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-100 hover:border-gray-300 "
        ...
        <div id="default-tab-content">
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 "  >
                        ...
                        <tbody>
                            ...
                            <tr class="odd:bg-white odd: even:bg-gray-50 even: border-b ">
                                ...
                                <td class="px-6 py-4">
                                    <button  class="font-medium text-blue-600  hover:underline" onclick="window.print()">Print invoice</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 " id="settings" role="tabpanel"
                ...
                <p class="text-sm text-gray-500 ">This is some placeholder content the <strong
                        class="font-medium text-gray-800 ">Settings tab's associated content</strong>.
