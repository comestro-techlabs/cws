                                            ...
                                            <ul class="list-group list-rankings">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <img src="{{ asset('assets/images/256_daniel-gaffey-1060698-unsplash.jpg')}}" class="img-fluid rounded-circle mr-2" width="30" alt="...">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <img src="{{ asset('assets/images/256_jeremy-banks-798787-unsplash.jpg')}}" class="img-fluid rounded-circle mr-2" width="30" alt="...">
                                                        <div class="media-body">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <img src="{{ asset('assets/images/256_michael-dam-258165-unsplash.jpg')}}" class="img-fluid rounded-circle mr-2" width="30" alt="...">
                                                        <div class="media-body">
                                                            <a href="#">Mark Ups</a>
                                                        </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <img src="{{ asset('assets/images/256_s-a-r-a-h-s-h-a-r-p-764291-unsplash.jpg')}}" class="img-fluid rounded-circle mr-2" width="30" alt="...">
                                                        <div class="media-body">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <img src="{{ asset('assets/images/256_luke-porter-261779-unsplash.jpg')}}" class="img-fluid rounded-circle mr-2" width="30" alt="...">
                                                        <div class="media-body">
                                                            <a href="#">John Mix</a>
                                                        </div>
