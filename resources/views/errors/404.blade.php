...
<body>
    ...
    <div class="flex md:flex-row flex-col p-10  items-center justify-center min-h-screen md:px-[10%]">
        <div class="flex-[1.5] flex flex-col gap-3">
            ...
            <h1 class="text-xl text-slate-500"><strong class="text-black">404</strong>. That's an error</h1>
            <p class="text-md md:text-2xl">The Requested URL <strong class="font-semibold">/{{request()->path()}}</strong> was not found on this server. <span class="text-slate-500">Thats all you know</span></p>
        </div>
        <div class="flex-1">
