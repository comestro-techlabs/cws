        ...
        <div class="divide-y divide-gray-200">
            @forelse($courses as $course)
                <div class="p-6">
                    ...
                    <div class="p-4 rounded-lg border border-gray-100 hover:border-blue-200 transition duration-200">
                            ...
                            <div class="mt-4 pl-8">
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="{{ $course->meeting_link }}" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            Join Meeting
                                        </a>
                                    </div>
                                    @endif
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <p class="text-sm text-gray-600">
                                            Password: <span class="font-medium">{{ $course->meeting_password }}</span>
                                        </p>
                                    </div>
                                    @endif
                                </div>
