                ...
                @else
                    <div class="space-y-4">
                        @foreach($messages as $message)
                            <a wire:navigate href="{{ route('v2.student.messages.show', $message->id) }}" class="flex items-center bg-gray-50 p-4 rounded-lg  hover:bg-gray-100 transition duration-300">
