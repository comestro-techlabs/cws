...
<script>
        ...
        Livewire.on('showAlert', (message) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('student.my-orders') }}"; 
                }
            });
        });
    });
    ...
    <div class="bg-gray-50 min-h-screen pt-6 mt-5 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="mt-6 flex justify-end">
                                <button wire:click="editShippingAddress" class="px-4 py-2 bg-purple-500 text-white rounded-lg focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition duration-200">
                                    Edit Address
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 sticky top-6">
                        <div class="p-6">
                            ...
                            <button wire:click="completeRedemption"
                                ...
                                {{ $shippingDetailsFilled ? 'bg-purple-500 text-white hover:bg-purple-700' : 'bg-gray-300 text-gray-500 cursor-not-allowed' }}"
            ...
            <!-- Back Button -->
            <div class="mt-8">
                <a href="{{ route('v2.student.products') }}" wire:navigate class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-primary transition duration-200">
