<div class="bg-gray-50 min-h-screen pt-6 mt-5 pb-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="{{ route('v2.student.products') }}"
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:border-purple-200 hover:shadow-md transition duration-200">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            <div class="flex items-center mt-1">
                                <span class="text-gray-500 text-sm mr-2">Date:</span>
                                <span>{{ $order->created_at->format('M d, Y') }}</span>
                            </div>
                            <div class="flex items-center mt-1">
                                <span class="text-gray-500 text-sm mr-2">Order Id:</span>
                ...
                <div class="bg-gray-50 px-5 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    <div class="flex items-center">
                        <span class="text-sm text-gray-500 mr-2">Delivery Address:</span>
                    ...
                    <div class="flex items-right">
                        <span class="text-sm text-gray-500 mr-2">Contact Number:
                        </span>
                        <span class="text-sm font-medium">
