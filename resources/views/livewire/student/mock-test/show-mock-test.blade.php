@php
    ...
    $percentage = $totalQuestions > 0 ? floor((count(array_filter($answers)) / $totalQuestions) * 100) : 0;

    $circumference = 2 * pi() * 40;
    $dashOffset =
        $totalQuestions > 0 ? $circumference * (1 - count(array_filter($answers)) / $totalQuestions) : $circumference;
@endphp
                        ...
                        <div class="mb-6 flex justify-center">
                            <div class="relative inline-flex items-center justify-center">
                                <svg class="w-24 h-24 transform -rotate-90">
                                    ...
                                    <circle class="text-blue-600" stroke-width="8" stroke="currentColor"
                                        fill="transparent" r="40" cx="48" cy="48"
                    ...
                    @if (count($questions) > 0)
                        <div class="bg-white border rounded-xl p-6">
                            ...
                            <div class="flex justify-between items-center p-4 bg-gray-50 rounded-xl mb-6">
                                <div>
                                    <h5 class="text-2xl font-bold text-gray-800">Question
                                        {{ $currentQuestionIndex + 1 }}</h5>
                            ...
                            <!-- Options -->
                            <div wire:key="question-{{ $questions[$currentQuestionIndex]['id'] }}"
                            ...
                            @if ($submitted)
                                <div
                                    class="mt-6 p-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded-lg">
