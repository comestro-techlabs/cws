    ...
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <strong class="mt-1 text-sm text-gray-500">You can update course batch only one time</strong>
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="mt-2 flex items-center justify-between">
                                                            <div class="flex items-center text-sm">
                                                                ...
                                                                <div class="flex items-center">
                                                                    @php
                                                                        $currentBatch = $course->batches->where(
                                                                            'id',
                                                                            $selectedBatch[$course->id] ?? null
                                                                        )->first();
                                                                    @endphp

                                                                    @if($currentBatch)
                                                                        <span class="text-gray-600">{{ $currentBatch->batch_name }}</span>
                                                                        <button wire:click="viewCourse({{ $course->id }})" class="ml-2 p-1 text-gray-400 hover:text-blue-600 rounded-full hover:bg-blue-50 transition-all duration-200
                                                        ...
                                                        @if($viewingCourse && $selectedCourse && $selectedCourse->id === $course->id)
                                                            <div class="mt-4 bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                                                                @if($studentUpdatedBatch[$course->id] ?? false)
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <p class="text-sm font-medium text-gray-700 flex items-center">
                                                                                ...
                                                                                Your Batch Selection
                                                                            </p>
                                                                            <p class="mt-1 text-sm text-gray-600">
                                                                                {{ $selectedCourse->batches->find($selectedBatch[$course->id])->batch_name ?? 'Not set' }}
                                                                            </p>
                                                                        </div>
                                                                ...
                                                                @else
                                                                    ...
                                                                    <div class="space-y-3">
                                                                        ...
                                                                        <select wire:model="selectedBatch.{{ $course->id }}"
                                                                        ...
                                                                        <div class="flex space-x-3 pt-2">
                                                                            <button wire:click="updateBatch({{ $course->id }})"
                                                                                ...
                                                                                <span wire:loading wire:target="updateBatch">
                                                                                    <svg class="animate-spin h-4 w-4 mr-1 inline"
