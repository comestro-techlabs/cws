                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="mt-2 flex items-center justify-between">
                                                <div class="flex items-center text-sm">
                                                    ...
                                                    @php
                                                        $currentBatch = $course->batches->where('id', $selectedBatch[$course->id] ?? null)->first();
                                                    @endphp
                                                    @if($currentBatch)
                                ...
                                <div class="bg-gray-50 rounded-xl p-5">
                                    ...
                                    @if(!$editingCourseId)
                                        <div class="flex items-center justify-between">
                                            ...
                                            <button wire:click="toggleEdit({{ $selectedCourse->id }})"
                                                class="text-sm bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-200">
                                                Select Batch
                                            </button>
                                        </div>
                                    @else
                                        <div class="space-y-4">
                                            <select wire:model.live="selectedBatch.{{ $selectedCourse->id }}"
                                                class="w-full text-sm border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-blue-500 focus:border-blue-500">
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <button wire:click="updateBatch({{ $selectedCourse->id }})"
                                                    ...
                                                    class="flex-1 inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50 transition duration-200">
                                                    <span wire:loading.remove
                                                        wire:target="updateBatch({{ $selectedCourse->id }})">
