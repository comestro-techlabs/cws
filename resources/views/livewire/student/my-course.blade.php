                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <select wire:model.live="selectedBatch.{{ $course->id }}"
                                                    class="flex-1 text-sm border border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
                                                ...
                                                <button wire:click="updateBatch({{ $course->id }})"
                                                    ...
                                                    class="inline-flex items-center px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors">
