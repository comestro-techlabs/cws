...
<footer class="bg-gray-700" aria-labelledby="footer-heading">
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8">
        <img class="h-20" src="{{ asset('assets/footer_logo.png') }}" alt="Company name">
        <p class="text-sm leading-6 text-white">Learn Syntax is a unit of <strong>Comestro Techlabs Pvt. Ltd.</strong></p>
  ...
  <path d="M2.75 2a.75.75 0 0 0-.75.75v10.5a.75.75 0 0 0 1.5 0v-2.624l.33-.083A6.044 6.044 0 0 1 8 11c1.29.645 2.77.807 4.17.457l1.48-.37a.462.462 0 0 0 .35-.448V3.56a.438.438 0 0 0-.544-.425l-1.287.322C10.77 3.808 9.291 3.646 8 3a6.045 6.045 0 0 0-4.17-.457l-.34.085A.75.75 0 0 0 2.75 2Z" />
      ...
      <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Marketing</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Analytics</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Commerce</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Insights</a>
              </li>
            </ul>
          </div>
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Pricing</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Documentation</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Guides</a>
              </li>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">About</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Blog</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Jobs</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Press</a>
              </li>
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Partners</a>
              </li>
            </ul>
          </div>
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="#" class="text-sm leading-6 text-white hover:text-gray-900">Claim</a>
              </li>
              <li>
    ...
    <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
      <p class="text-xs leading-5 text-white">&copy; 2025 Learn Syntax. All rights reserved.</p>
    </div>
  </div>
</footer>
</div>
