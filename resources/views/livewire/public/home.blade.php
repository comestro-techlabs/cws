<div>
    ...
    <div class="bg-gradient-to-r from-purple-50 via-purple-300 to-purple-100  py-12">
        <div class="dark:bg-gray-900 ">
            <div
                ...
                <div
                    class="pb-12 mt-10 dark:bg-gray-900 sm:pb-16 bg-gradient-to-r from-purple-50 via-purple-300 to-purple-100">
                    <div class="relative">
                        <div
                            class="absolute inset-0 h-1/2  dark:bg-gray-900 bg-gradient-to-r from-purple-50 via-purple-300 to-purple-100">
                        </div>
                        <div class="relative max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
                            <div class="max-w-4xl mx-auto">
                                <dl
                                    class="bg-white dark:bg-gray-800 rounded-lg shadow-lg sm:grid sm:grid-cols-3 bg-gradient-to-r from-purple-50 via-purple-300 to-purple-100">
                                    <div
    ...
    <div class="bg-white py-12 pt-5 md:mt-20">
        ...
        <div class="flex flex-col sm:flex-row gap-6 max-w-7xl mx-auto px-4 justify-center items-center">
            <div
                class="relative flex flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12 w-full sm:w-auto">
                <div
                    ...
                    <span
                        class="absolute top-10 z-0 h-20 w-20 rounded-full bg-primary transition-all duration-300 group-hover:scale-[10]"></span>
                    <div class="relative z-10 mx-auto max-w-md">
                        <span
                            class="grid h-20 w-20 place-items-center rounded-full bg-primary transition-all duration-300 group-hover:bg-primary">
                        ...
                        <div class="pt-5 text-base font-semibold leading-7">
                            <p>
                                <a href="#" class="text-primary transition-all duration-300 group-hover:text-white">Read
                                    the docs &rarr;</a>
                            </p>
                        </div>
                    </div>
