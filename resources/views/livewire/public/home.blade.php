<div>
    ...
    <div class="pt-24 pb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900">Our <span class="text-blue-600">Courses</span></h2>
                ...
                <div class="flex flex-col bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 right-4 flex items-center space-x-1">
                            <div class="px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-sm font-medium text-yellow-600 flex items-center">
                    ...
                    <div class="flex-1 p-6 space-y-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="{{route('v2.public.courseDetail', ['slug' => $item->slug])}}" wire:navigate
                                class="block w-full px-4 py-3 text-center font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                                Enroll Now
                            </a>
                        </div>
                    </div>
            ...
            <div class="mt-12 text-center">
                <a href="{{route('v2.public.viewallcourses.all-courses')}}" wire:navigate
                    class="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                    View All Courses
    ...
    <div class="bg-gradient-to-b from-gray-50 to-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900">Popular Course <span class="text-blue-600">Categories</span></h2>
                <p class="mt-4 text-xl text-gray-600 max-w-2xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-600 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#" class="inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-lg text-blue-600 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                    Get Started Today
                </a>
                <a href="#" class="inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-lg text-white bg-blue-500 bg-opacity-30 hover:bg-opacity-40 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                    Browse All Courses
                </a>
            </div>
        </div>
    ...
    <div class="relative bg-gradient-to-b from-gray-50 to-white py-24">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900">Our <span class="text-blue-600">Alumni</span> Success Stories</h2>
            ...
            <div class="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <!-- Content -->
                    <div class="relative">
                        <div class="h-40 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-transparent">
                            ...
                            <div class="flex items-center">
                                @if($student->image)
                                    <img src="{{ asset('/storage/placedstudent/' . $student->image) }}" 
                                        alt="{{ $student->name }}" 
                                        class="h-14 w-14 rounded-full object-cover border-2 border-blue-50"
                                    />
                                @else
                                    <div class="h-14 w-14 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center">
            ...
            <div class="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-xl p-6 text-center shadow-lg">
                    <div class="text-3xl font-bold text-blue-600">₹12L</div>
