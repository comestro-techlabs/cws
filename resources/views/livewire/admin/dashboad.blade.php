<main class="mt-5">
    ...
    <div class="col-span-12 space-y-6 xl:col-span-7">
            ...
            <div
                ...
                <div class="mt-5 flex items-end justify-between">
                    <div>
                        ...
                        <h4 class="mt-2 text-xl font-bold text-gray-800 dark:text-white/90">3,782</h4>
                    </div>
                    <span
                        class="flex items-center gap-1 rounded-full bg-green-100 py-0.5 pl-2 pr-2.5 text-sm font-medium text-green-600 dark:bg-green-500/15 dark:text-green-500">
            ...
            <div
                ...
                <div class="mt-5 flex items-end justify-between">
                    <div>
                        ...
                        <h4 class="mt-2 text-xl font-bold text-gray-800 dark:text-white/90">5,359</h4>
                    </div>
                    <span
        ...
        <div
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <div x-data="{openDropDown: false}" class="relative">
                    ...
                    <div x-show="openDropDown" @click.outside="openDropDown = false"
                        ...
                        <button
                            class="flex w-full px-3 py-2 font-medium text-left text-gray-500 rounded-lg text-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                            View More
                        </button>
                        <button
                            class="flex w-full px-3 py-2 font-medium text-left text-gray-500 rounded-lg text-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
            ...
            <div class="max-w-full overflow-x-auto custom-scrollbar">
                <div class="min-w-[650px] xl:min-w-full">
                    <canvas id="chartOne" class="h-[300px]"></canvas>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-span-12 xl:col-span-5">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Chart Two</h3>
            <canvas id="chartTwo" class="h-[300px]"></canvas>
        </div>
    </div>
    ...
    <div class="col-span-12 mb-5">
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Statistics
                spn</h3>
            <canvas id="chartThree" class="h-[100px]"></canvas>
        </div>
    </div>
    </div>
    <div
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Initialize Chart.js for Chart One
        ...
        // Initialize Chart.js for Chart Two
        ...
        // Initialize Chart.js for Chart Three
