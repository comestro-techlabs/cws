        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                            <a href="{{ route('admin.placedstudent.index') }}" wire:navigate
                                ...
                                <div class="p-2 bg-blue-50 rounded-lg group-hover:bg-blue-100 transition-colors">
                                    <svg class="lg:w-6 w-4 lg:h-6 h-4 text-blue-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                                    </svg>
                                </div>
                                <span class="text-xs text-center font-medium text-gray-700 mt-2">Placed Student</span>
                            </a>

                            <a href="{{ route('admin.course') }}" wire:navigate
                                class="flex flex-col items-center p-3 rounded-xl hover:bg-gray-50 transition-all group">
                                <div class="p-2 bg-green-50 rounded-lg group-hover:bg-green-100 transition-colors">
                                    <svg class="lg:w-6 w-4 lg:h-6 h-4 text-green-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="{{ route('admin.attendance') }}" wire:navigate
                                ...
                                <div class="p-2 bg-indigo-50 rounded-lg group-hover:bg-indigo-100 transition-colors">
                                    <svg class="lg:w-6 w-4 lg:h-6 text-indigo-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="{{ route('admin.exam') }}" wire:navigate
                                ...
                                <div class="p-2 bg-yellow-50 rounded-lg group-hover:bg-yellow-100 transition-colors">
                                    <svg class="lg:w-6 w-4 lg:h-6 h-4 text-yellow-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="relative flex items-start justify-between">
                        ...
                        <div class="hidden md:block opacity-10 group-hover:opacity-20 transition-opacity duration-300">
                            <svg class="w-24 h-24 text-indigo-500" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M12 14c-3.313 0-6-2.687-6-6s2.687-6 6-6 6 2.687 6 6-2.687 6-6 6zm0-10c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4z" />
                            </svg>
                        </div>
                    </div>
                    <div
                        class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-indigo-500 to-indigo-300 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500">
                    </div>
                </div>
                    ...
                    <div class="relative flex items-start justify-between">
                        ...
                        <div class="hidden md:block opacity-10 group-hover:opacity-20 transition-opacity duration-300">
                            <svg class="w-24 h-24 text-purple-500" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M19 2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V4a2 2 0 00-2-2zm-2 8H7V8h10v2z" />
                            </svg>
                        </div>
                    </div>
                    <div
                        class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-500 to-purple-300 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500">
                    </div>
                </div>
                ...
                <div class="relative border border-gray-100 bg-white rounded-2xl p-6 overflow-hidden group animate-fade-in-up"
                            ...
                            <div>
                                <div class="flex items-baseline">
                                    ...
                                    <h2 class="text-3xl font-bold text-gray-900">
                                        {{ number_format($currentMonthAmount, 2) }}</h2>
                                </div>
                    ...
                    <div
                        class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-green-500 to-green-300 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500">
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <a href="{{ route('admin.attendance') }}" wire:navigate class="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 group
                    ...
                    <div
                        class="p-3 bg-indigo-50 rounded-full w-12 h-12 flex items-center justify-center mb-4 group-hover:bg-indigo-100">
                ...
                <a href="{{ route('admin.student') }}" wire:navigate class="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 group
                          transform hover:-translate-y-1 duration-300 animate-fade-in-up"
                    style="animation-delay: 500ms">
                    <div
                        class="p-3 bg-purple-50 rounded-full w-12 h-12 flex items-center justify-center mb-4 group-hover:bg-purple-100">
                ...
                <a href="{{ route('admin.assignment.manage') }}" wire:navigate class="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 group
                          transform hover:-translate-y-1 duration-300 animate-fade-in-up"
                    style="animation-delay: 600ms">
                    <div
                        class="p-3 bg-green-50 rounded-full w-12 h-12 flex items-center justify-center mb-4 group-hover:bg-green-100">
                ...
                <a href="{{ route('admin.exam') }}" wire:navigate class="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 group
                          transform hover:-translate-y-1 duration-300 animate-fade-in-up"
                    style="animation-delay: 700ms">
                    <div
                        class="p-3 bg-yellow-50 rounded-full w-12 h-12 flex items-center justify-center mb-4 group-hover:bg-yellow-100">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">{{ $course->duration }} Weeks •
                                                {{ $course->category->cat_title ?? 'Uncategorized' }}</p>
                                        </div>
                                    </div>
