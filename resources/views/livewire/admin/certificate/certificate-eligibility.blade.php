<div>
    ...
    <div class="container mt-5">
        <div class="overflow-x-auto">
                        ...
                        @foreach ($userData as $data)
                            <tr>
                                ...
                                <td class="border border-gray-300 px-4 py-2">
                                    <a href="{{ route('admin.viewCertificate', ['userId' => $data['id']]) }}" 
                                       class="p-2 bg-green-100 text-green-700 rounded inline-block">
            ...
            @else
                <p class="text-center text-red-500 mt-4">❌ No eligible candidates found.</p>
            @endif
        </div>
    </div>
</div>