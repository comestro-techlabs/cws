                ...
                <form wire:submit.prevent class="space-y-8">
                    <div class="bg-white   mb-6">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button wire:click="courseEdit" class="px-3 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors">
                                Edit
                            </button>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-8">
                            ...
                            <div class="col-span-1 sm:col-span-4 md:col-span-3">
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 bg-gray-50 shadow-sm">
                                <div wire:loading wire:target="tempImage" class="mb-4">
                                                    ...
                                                    <div class="mt-4 flex gap-2">
                                                        <input type="file" wire:model="tempImage" class="hidden"
                                                            id="image-upload">
                                                        ...
                                                        @if ($tempImage)
                                                            <button wire:click="handleImageUpload"
                                                                wire:loading.attr="disabled" wire:target="handleImageUpload"
                                                                class="px-4 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors disabled:opacity-50">
                                                                <span wire:loading.remove
                                                                    wire:target="handleImageUpload">Upload</span>
                                                                <span wire:loading
                                                                    wire:target="handleImageUpload">Saving...</span>
                                                            </button>
                                                        @endif
                                                    </div>
                                </div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center justify-between mb-4">
                                                    ...
                                                    <p class="text-gray-800 text-sm font-medium">
                                                        {{ $course->course_code ?? 'N/A' }}</p>
                                                </div>
                                                <div class="flex items-center justify-between mb-4">
                                                    <p class="text-gray-500 text-sm">Duration</p>
                                                    <p class="text-gray-800 text-sm font-medium">
                                                        {{ $course->duration }} Weeks</p>
                                                </div>
                                            </div>
                                            <!-- Right Column -->
                                            <div>
                    ...
                    <div class="mb-8 mt-2 border-b border-gray-200">
                                <nav class="-mb-px flex flex-col sm:flex-row sm:space-x-8" aria-label="Tabs">
                                    @foreach(['addBatch' => 'Add Batch', 'feature' => 'Feature','description'=>'Description & Venue'] as $tab => $label)
                                    ...
                                    <div class="pt-6">
                                        ...
                                        <div class="space-y-2">
                                            <textarea wire:model.defer="description" rows="4" @if($editingField !== 'description') readonly @endif
                            ...
                            <div class="flex gap-2 mt-2 relative">
                                <textarea wire:model.defer="venue" rows="3"
                                          @if($editingField !== 'venue') readonly @endif
                                          class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-1 focus:ring-purple-500 focus:border-purple-500 
                                ...
                                <div wire:ignore.self
                                    ...
                                    <div class="bg-white rounded-lg p-6 w-full max-w-2xl">
                                        ...
                                        <form wire:submit.prevent="updateFeatures" class="space-y-4">
                                            <div
                                                class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 max-h-64 overflow-y-auto">
