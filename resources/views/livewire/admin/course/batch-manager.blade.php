<div class="flex flex-col lg:flex-row w-full gap-6">
    <!-- Left Section: Add New Batch -->
    <div class="lg:w-6/12 w-full p-2">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="batchName"
                        class="mt-1 p-2 block w-full rounded-md border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
