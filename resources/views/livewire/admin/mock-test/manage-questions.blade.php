<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-xl font-semibold text-slate-500 border-s-4 border-s-purple-600 pl-3">
                    Mock Test: <span class="text-purple-600">{{ $mockTest->test_title }}</span>
                </h2>
                <p class="text-sm text-gray-600 mt-1 ml-4">Manage questions for this mock test</p>
            </div>
