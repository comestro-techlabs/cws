                                                        ...
                                                        <table class="min-w-full bg-white border border-gray-200 text-xs sm:text-sm">
                                                            <thead class="bg-gray-200 text-center">
                                                                <tr>
                                                                    ...
                                                                    <th class="p-2 sm:p-3 font-medium text-gray-600 border">Amount/Paid</th>
                                                                    <th class="p-2 sm:p-3 font-medium text-gray-600 border">Due Amount</th>
                                                            ...
                                                            <tbody>
                                                                @forelse($purchasedCourses as $payment)
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td class="px-2 sm:px-4 py-2 border">{{ $payment->amount }}/{{ $payment->total_amount }}</td>
                                                                        <td class="px-2 sm:px-4 py-2 border">
                                                                            @php
                                                                                $dueAmount = $payment->amount - $payment->total_amount;
                                                                            @endphp
                                                                            {!! $dueAmount == 0 ? '<span class="text-green-500">Paid</span>' : $dueAmount !!}
                                                                        </td>
                                                                        <td class="px-2 sm:px-4 py-2 border">
                                                                        ...
                                                                        <td class="flex gap-4 px-2 sm:px-4 py-2 border">
                                                                            @if ($payment->amount > $payment->total_amount)
                                                                                <button wire:click="openDuePaymentModal({{ $payment->id }})"
                                                                ...
                                                                @empty
                                                                    <tr>
                                                                        <td colspan="8" class="px-2 sm:px-4 py-2 text-center">No courses purchased.</td>
                                                                    </tr>
                                                                @endforelse
                                                            </tbody>
                                                        </table>
                ...
                <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div class="bg-white p-6 rounded-lg w-full max-w-md">
                        <h2 class="text-lg font-semibold mb-4">
                            {{ $paymentId ? 'Pay Due Amount' : 'Enroll in Course' }}
                        </h2>
                        <form wire:submit.prevent="{{ $paymentId ? 'payDueAmount(' . $paymentId . ')' : 'saveEnrollment' }}" class="p-4 sm:p-6">
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <label class="block text-gray-700">Full Course Amount</label>
                                <input type="number" wire:model="amount" class="w-full p-2 border rounded" readonly>
                            </div>
                            <div class="mb-4">
                                <label class="block text-gray-700">Amount to Pay</label>
                                <input type="number" wire:model="total_amount" class="w-full p-2 border rounded" max="{{ $amount - ($paymentId ? ($purchasedCourses->find($paymentId)->total_amount ?? 0) : 0) }}">
