<div>
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            ...
            <div class="relative">
                 <!-- Categories Table -->
            <div class="relative flex flex-col w-full h-full overflow-x-auto text-gray-700 bg-white shadow-md rounded-lg bg-clip-border {{ $isModalOpen ? 'blur-sm' : '' }}">
                ...
                <!-- Modal -->
                @if($isModalOpen)
                    <div class="fixed inset-0 bg-gray-200 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50">
