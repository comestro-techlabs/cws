            ...
            <form wire:submit.prevent='store'>
                ...
                <div class="mb-3 flex flex-col gap-2">
                    ...
                    <textarea rows="5" wire:model="cat_description" id="cat_description"
                        class="border w-full px-3 py-2 rounded"></textarea>
                ...
                <div class="mb-3 flex justify-center items-center">
                    <button type="submit"
                        class="bg-purple-500 hover:bg-purple-700 text-white font-bold w-full px-8 py-2 rounded">Create</button>
                </div>
            </form>
        </div>
    </div>
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div class="flex gap-3 flex-col md:flex-row justify-between md:items-center">
                <h2 class="md:text-xl text-lg font-semibold  text-slate-500 border-s-4 border-s-purple-800 pl-3">Manage
                    Categories</h2>
            </div>
            <!-- Categories Table -->
