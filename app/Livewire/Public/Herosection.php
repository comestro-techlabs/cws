                                ...
                                <div class="flex-1 pt-10 lg:py-10 w-full">
                                    <div class="p-8 md:p-10 lg:p-12 text-white">
                                        ...
                                        <div class="mt-10 lg:px-20 mx-auto"> 
                                                <div class="grid grid-cols-2 md:grid-cols-6 gap-4 px-8 justify-center"> 
                                                    @foreach($courses as $course)
                                                        <div class="bg-white border-2 border-grey-600 text-white rounded-lg shadow-md">
                                                            <a href="{{ route('v2.courses.show', $course->id) }}" wire:navigate>
                                                                <div class="flex flex-row items-center">
                                                                <svg wire:ignore width="50" height="50" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <div class="text-gray-900 flex-grow truncate px-3 py-2 rounded-md">{{ $course->title }}</div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    @endforeach
